...
export default function ContractsPage() {
  ...
  // Per-folder contracts: Record<folderId, Document[]>
  const [contractsByFolder, setContractsByFolder] = useState<Record<number, Document[]>>({
    1: [], // will be replaced by API data on load
  ...
  const loadContracts = async () => {
    try {
      ...
      // API contracts go to folder 1 (Clientes)
  ...
  // ─── Contract mutations (scoped to active folder) ─────────────────────────
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Folder Tabs (tabs + "+ Nueva carpeta" inline) */}
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 text-slate-700"
                  >
        ...
        <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-medium text-slate-700 transition-all hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm"
            >
